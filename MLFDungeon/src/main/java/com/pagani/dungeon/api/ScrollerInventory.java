...
public class ScrollerInventory{
    ...
    public int atual = 1;
    public static HashMap<String, ScrollerInventory> users = new HashMap<String, ScrollerInventory>();
    public static HashMap<String, ScrollerInventory> users2 = new HashMap<String, ScrollerInventory>();
...
//open page 0 for the specified player
    ...
    private Inventory getBlankPage(String name,String username,boolean inspect,String correioID){
        ...
        if(inspect) {
            if(Main.cache.get(username).getCache().size() > 21) {
